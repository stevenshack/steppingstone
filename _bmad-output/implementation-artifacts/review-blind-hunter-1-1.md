# Blind Hunter — Code Review: Story 1-1

You receive ONLY the diff below. No spec, no project context, no additional information.
...
Output findings as a Markdown list. Each finding: one-line title, severity (Critical/High/Medium/Low), and evidence from the diff.
